...
var distractionTaskInstructionTime = 2 * 1000;
var distractionTaskDisplayTime = 10 * 1000;
var distractionTaskSelectTime = 10 * 1000;
...
function drop(ev) {
	...
	if(distractionStages[distractionStageCounter] == "select"){
		...
		console.log("DROP "+location + " " + content);
...
// TODO: 'delete image' if put back/ put outside
